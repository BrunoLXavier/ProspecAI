...
export const navigationItems: NavigationItem[] = [
  ...
  { id: 'feedbackManagement', name: 'feedbackManagement', href: '/feedback', icon: ClipboardDocumentListIcon },
  ...
  { id: 'reports', name: 'reports', href: '/reports', icon: ChartPieIcon },
  { id: 'reportTemplates', name: 'reportTemplates', href: '/report-templates', icon: DocumentDuplicateIcon },
