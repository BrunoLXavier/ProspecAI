...
import { PageHeader, ConfirmModal } from '@/components/features/shared/ui';
import {
  useReportTemplates,
  useDeleteTemplate,
  useGenerateReport,
              ...
              >
                <div className="p-5">
                  ...
                  <div className="flex flex-wrap gap-1.5 mt-3">
                    {template.output_formats?.map((format: OutputFormat) => (
                      <span
                        key={format}
                ...
                <div className="flex items-center justify-between px-5 py-3 bg-gray-50 dark:bg-gray-800/50 
                  ...
                  <div className="flex items-center gap-1">
                    <Link
                      href={`/report-builder?edit=${template.id}`}
                  ...
                  <div className="relative group">
                    ...
                    <div className="absolute right-0 bottom-full mb-2 w-32 bg-white dark:bg-gray-800 
                      ...
                      {(template.output_formats || ['html', 'csv', 'json']).map((format: OutputFormat) => (
                        <button
                          key={format}
