              ...
              <Dialog.Panel className="w-full max-w-3xl transform overflow-hidden rounded-2xl bg-white p-6 shadow-xl transition-all">
                ...
                {canCreate ? (
                  ...
                  <div className="py-12 px-6 text-center">
                    ...
                    <p className="text-sm text-gray-600 mb-6">{t('noPermissionMessage') || 'You must be an administrator or have at least one selected institute to create an opportunity. Select your institute in the header or contact an administrator.'}</p>
