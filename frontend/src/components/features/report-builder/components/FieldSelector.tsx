...
import { useTableSchema, useTableJoins } from '@/hooks/use-report-builder';
import type { FieldSchema, TableSchema, RelationshipSchema } from '@/components/features/report-builder/types';
